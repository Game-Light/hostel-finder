          ...
          {loading ? (
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2.5 px-3 py-2 rounded-full transition-all hover:bg-white/10"
              >
                {/* Avatar */}
                <div
              ...
              {menuOpen && (
                <div
                  className="absolute right-0 top-full mt-2 w-52 rounded-2xl shadow-xl overflow-hidden border"
                ...
                >
                  ...
                  <div className="border-t py-1" style={{ borderColor: '#E8EDEB' }}>
                    <button
                      ...
                      className="flex items-center gap-3 w-full px-4 py-2.5 text-sm font-medium hover:bg-red-50 transition-colors"
                      style={{ color: '#DC2626' }}
                    >
            ...
            <>
              ...
              <Link href="/register" style={{ backgroundColor: '#37D76A' }} className="text-[#034338] font-bold text-sm px-5 py-2.5 rounded-full hover:opacity-90 transition-opacity">
                List your hostel
              </Link>
            </>
          )}
